classdef LayerAnalyzer < handle
    ...
    properties ( Dependent )
        ...
        IsClassficationLayer(1,1) logical;
    ...
    methods ( Hidden, Access = protected )
        ...
        function validateInputs(this)
            ...
            % sizes that will be used to propagate (regarless of the layer
    ...
    methods
        ...
        function tf = get.IsClassficationLayer(this)
        ...
        function tf = get.IsRNNLayer(this)
            tf = isa(this.InternalLayer, 'nnet.internal.cnn.layer.Updatable');
        end
