classdef BiLSTMGPUReturnLastStrategy < nnet.internal.cnn.layer.util.ExecutionStrategy
    % BiLSTMGPUReturnLastStrategy   Execution strategy for running BiLSTM on
    ...
    methods
        function [Y, memory] = forward(this, X, W, R, b, c0, y0)
            ...
            [Yfull, HY, CY, Ws] = nnet.internal.cnngpu.biLSTMForwardTrain(X, HX, CX, Wc);
    ...
    methods(Access = protected)
        ...
        function [Yfull, HY, CY, dYfull, dHY, dCY, X, HX, CX, Wc, Ws, H, D] = prepareDataForBackward(~, X, W, R, b, c0, y0, memory, dY)
            % Prepare data passed into the strategy for the internal
            % backward method
