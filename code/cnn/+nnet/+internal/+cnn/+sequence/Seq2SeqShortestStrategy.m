classdef Seq2SeqShortestStrategy < nnet.internal.cnn.sequence.NextStrategy & nnet.internal.cnn.sequence.Utilities
    ...
    methods
        function this = Seq2SeqShortestStrategy(readStrategy, dataSize, responseSize, paddingValue)
        ...
        function [miniBatchData, miniBatchResponse, advanceSeq] = nextBatch(this, data, response, indices, ~)
            ...
            miniBatchResponse = this.initializeMiniBatch( this.ResponseSize, batchSize, shortestSeq, this.PaddingValue );
            ...
            for ii = 1:batchSize
                ...
                miniBatchResponse(:, ii, :) = responseSeq(:, 1:shortestSeq);
            end
        end
    end
end