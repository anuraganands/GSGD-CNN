classdef SolverTESTGD < nnet.internal.cnn.solver.Solver
    % SolverTESTGD   Stochastic gradient descent with momentum (SGDM) solver.
    ...
    methods(Hidden)
        function this = SolverTESTGD(learnableParameters,precision,options)
            % this = SolverTESTGD(learnableParameters,precision,options)
            % creates a SolverTESTGD object for optimizing parameters in
